...
const loginCliente = async (req, res) => {
  ...
  const registrarCliente = async (req, res) => {
    ...
    try {
      ...
      const nuevoCliente = await Cliente.create({ correo, nombre, telefono, password: hashedPassword });
  ...
  const actualizarCliente = async (req, res) => {
    ...
    try {
      const clienteActualizado = await Cliente.update(id, { correo, nombre, telefono });
